...
CREATE TABLE `clientes` (
  ...
  `tipo_doc` enum('NIT','CC','CE','Pasaporte') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'CC',
  `num_doc` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `digito_ver` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `compras` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Código único: CMP-YYYY-NNNN',
  `proveedor_id` int unsigned NOT NULL,
  `producto_id` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `cantidad` decimal(10,2) NOT NULL,
  `unidad` enum('kg','g') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kg' COMMENT 'kg para cacao_grano | g para chocolate_mesa',
...
CREATE TABLE `movimientos_inventario` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `producto_id` int unsigned NOT NULL,
  `tipo` enum('entrada','salida','ajuste_inicial') COLLATE utf8mb4_unicode_ci NOT NULL,
  `cantidad` decimal(10,2) NOT NULL,
  `stock_antes` decimal(10,2) NOT NULL,
  `stock_despues` decimal(10,2) NOT NULL,
  `referencia_tipo` enum('compra','venta','inicial') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `productos` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` enum('cacao_grano','chocolate_mesa') COLLATE utf8mb4_unicode_ci NOT NULL,
  `presentacion` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Ej: 250g, 500g. Solo para chocolate_mesa',
  `unidad` enum('kg','g','unidad') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kg' COMMENT 'kg para cacao_grano | g para chocolate_mesa | unidad para presentaciones empacadas',
...
INSERT INTO `productos` VALUES (1,'Cacao en Grano Seco','cacao_grano',NULL,'kg',35.91,50.00,3500.00,1,'2026-05-03 17:04:57'),(2,'Chocolate de Mesa 250g','chocolate_mesa','250g','g',10.00,20.00,4500.00,1,'2026-05-03 17:04:57'),(3,'Chocolate de Mesa 500g','chocolate_mesa','500g','g',10.00,20.00,8500.00,1,'2026-05-03 17:04:57'),(4,'Chocolate de Mesa 1000g','chocolate_mesa','1000g','g',7.00,10.00,16000.00,1,'2026-05-03 17:04:57'),(5,'Chocolate de Mesa 25g','chocolate_mesa','25g','g',10.00,10.00,2000.00,1,'2026-05-03 22:45:04');
...
CREATE TABLE `proveedores` (
  ...
  `num_doc` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `digito_ver` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo_proveedor` enum('Agricultor','Intermediario','Cooperativa','Empresa') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Agricultor',
...
INSERT INTO `usuarios` VALUES (1,'Administrador','admin@chocotumac.com','$2y$12$zjXB5m3lAgnGCzw6rQuxme/fE6VJguWESJTxlTPbJ0hPZukhkkeG2','3209876546',1,'2026-05-04 10:06:38','2026-04-30 21:24:36'),(2,'Nathalia Mejia','nathmejia@chocotumac.com','$2y$12$J2igzaiyojeFfyLtBALnW.THGCRErMn8pBAqA7pdOHIRlm.Mfuynq','3158539049',1,'2026-04-30 22:12:09','2026-04-30 21:44:39'),(3,'David Gomes','davidg@chocotumac.com','$2y$12$7hLToR6elqeG6OclmRC3W.VjuU9kMLnGriMy/zp64VMxNYyIy7Coi','3154491214',3,'2026-05-03 23:14:45','2026-04-30 21:50:12'),(5,'isaura Ruiz','isaura2022@chocotumac.com','$2y$12$YcQIdxkxI9GhHKBEIb/HCOddPesr5CZInUYYBxa5ZkA63.rLFLQRm','3116789043',1,'2026-04-30 22:22:19','2026-04-30 21:53:06'),(9,'Elkin Buitrago','elkin12@chocotumac.com','$2y$12$z08Wdeo4waKXmjRCnq8Oa.CfsXJqu4rXYMpLnxg3WBrzPUthKzCgO',NULL,2,'2026-05-03 23:20:45','2026-05-03 23:20:13');
...
CREATE TABLE `ventas` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `codigo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Código único de factura: FAC-YYYY-NNNN',
  `cliente_id` int unsigned DEFAULT NULL,
  `cliente_ocasional` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nombre del cliente cuando no está registrado en el sistema',
  `doc_ocasional_tipo` enum('CC','CE','NIT','Pasaporte') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tipo de documento para cliente ocasional',
  `doc_ocasional_num` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Número de documento para cliente ocasional',
  `producto_id` int unsigned NOT NULL,
  `fecha` date NOT NULL,
  `cantidad` decimal(10,2) NOT NULL,
  `precio_unitario` decimal(10,2) NOT NULL,
...
INSERT INTO `ventas` VALUES (1,'FAC-2026-0001',NULL,'Cliente general',NULL,NULL,4,'2026-05-04',1.00,16000.00,16000.00,NULL,1,'2026-05-03 23:13:09'),(2,'FAC-2026-0002',4,NULL,NULL,NULL,4,'2026-05-04',2.00,16000.00,32000.00,NULL,3,'2026-05-03 23:15:43');
...
-- Dump completed on 2026-05-04 10:41:56
